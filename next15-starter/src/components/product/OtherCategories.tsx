    ...
    <section className="mx-auto w-full max-w-7xl px-4 py-12 md:py-16">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {categories.map((category) => {
          const imageUrl = getSafeMediaUrl(category.cardImage);
          const imageAlt = getSafeMediaAlt(category.cardImage, category.name);
          const imageSize = getSafeMediaDimensions(category.cardImage, 900, 675);
