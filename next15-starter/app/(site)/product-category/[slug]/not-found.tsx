...
export default function ProductCategoryNotFound() {
  return (
    <section className="mx-auto flex min-h-[55vh] w-full max-w-3xl flex-col items-center justify-center px-4 py-16 text-center">
      ...
      <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-900">Category not found</h1>
      <p className="mt-4 max-w-xl text-sm text-slate-600 md:text-base">
        The requested product category could not be resolved from WordPress.
      </p>
      <Link
        href="/"
